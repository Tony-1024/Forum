...
public class IndexAction extends Action {
	...
	static{
		...
		searchSQL.add(new LabelValueBean("Post Title","bbs_title"));
		searchSQL.add(new LabelValueBean("Post Content","bbs_content"));
		searchSQL.add(new LabelValueBean("Post Publisher","bbs_sender"));		
		
		headFace=new Vector();
		for(int i=0;i<22;i++){
			String gif="user"+i+".gif";
			headFace.add(new LabelValueBean("ͷ��"+(i+1),gif));			
		}		
	}
}
