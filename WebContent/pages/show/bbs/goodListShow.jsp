...
<html>
  <head>
    <title>Show the essence post</title>
  </head>
  <body>
    <center>
      <table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E3E3E3" bordercolordark="white" rules="rows" style="margin-top:8">
          <tr height="30"><td colspan="5" style="text-indent:5" background="images/index/classT.jpg"><b><font color="white">■ Essence Post</font></b></td></tr>
          ...
          <logic:notPresent name="goodlist" scope="session">
              <tr height="180"><td bgcolor="#F9F9F9" align="center" colspan="5"><li>Sorry, the post list does not exist!</li></td></tr>
          </logic:notPresent>
			  ...
			  <tr>
                  <td colspan="5">
                      ...
                      <tr height="35" bgcolor="#F9F9F9">
                          <td width="8%" align="center">Essence</td>
